    ...
    if (vlSelf->top__DOT__dut__DOT__rst_id_ex) {
        if (vlSelf->top__DOT__dut__DOT__enable_id_ex) {
            ...
            vlSelf->top__DOT__dut__DOT__rs2_addr_ex 
                = vlSelf->top__DOT__dut__DOT__rs2_addr_id;
            __Vdly__top__DOT__dut__DOT__rd_wren_ex 
                = vlSelf->top__DOT__dut__DOT__rd_wren_id;
            __Vdly__top__DOT__dut__DOT__is_load_ex 
            ...
            vlSelf->top__DOT__dut__DOT__rs2_addr_ex 
                = vlSelf->top__DOT__dut__DOT__rs2_addr_ex;
            __Vdly__top__DOT__dut__DOT__rd_wren_ex 
                = vlSelf->top__DOT__dut__DOT__rd_wren_ex;
            __Vdly__top__DOT__dut__DOT__is_load_ex 
        ...
        __Vdly__top__DOT__dut__DOT__rd_wren_ex = 0U;
        __Vdly__top__DOT__dut__DOT__is_load_ex = 0U;
...
VL_INLINE_OPT QData Vtop___024root___change_request_1(Vtop___024root* vlSelf) {
    ...
    VL_DEBUG_IF( if(__req && ((vlSelf->top__DOT__dut__DOT__rst_if_id ^ vlSelf->__Vchglast__TOP__top__DOT__dut__DOT__rst_if_id))) VL_DBG_MSGF("        CHANGE: ../src/singlecycle.sv:112: top.dut.rst_if_id\n"); );
    // Final
